...
MONGO_HOST = "172.11.0.11"
MONGO_DB = "admin"  # TODO: To be removed
MONGO_USER = ""  # TODO: To be removed
MONGO_PASS = ""  # TODO: To be removed
...
MONGO_CLIENT = MongoClient("mongodb://{}/{}".format(MONGO_HOST, MONGO_DB))
    ...
    while True:
        ...
        try:
            ...
            for image_upload_obj in images_ready_to_upload:
                ...
                except imgur_helpers.error.ImgurClientRateLimitError:
